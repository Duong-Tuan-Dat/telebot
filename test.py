...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # --- Bước 1: Nhắn tin khi đang chờ ảnh ---
    if state == "waiting_for_photo":
        await update.message.reply_text("qua đây mà hỏi")
        return
    # --- Bước 2: Nhắn tin khi đang chờ ảnh 2 ---
    elif state == "waiting_for_photo_2":
        await update.message.reply_text("vui lòng làm lại, thắc mắc gì qua đây mà hỏi")
        return
